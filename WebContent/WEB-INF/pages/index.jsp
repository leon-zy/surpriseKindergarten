...
<body>
	<!-- start header_top -->
	<div class="header" id="topHeader" ng-controller="scrollController">
		<div class="container">
			<div class="header-text">
				<h1>Perfect Preschool</h1>
				<h2>聆听童话，让孩子生活在童话的世界</h2>
				<p>真正的学习英语，将美国原版课程引进中国，旨在为3-18岁的幼儿、青少年提供纯正美式英语教育。
在全浸入式英语环境中，激发孩子的英语学习兴趣，英语如母语般运用自如。</p>
				<div class="banner_btn">
					<a href="#menu" ng-click="scrollTop($event)">Read More</a>
				</div>
			</div>
